...
/**
 * Phase 0 foundation smoke screen, kept at /foundation as a dev reference.
 * Exercises the shared UI kit, state components, hooks, and the service
 * registry (mock or real API).
 */
